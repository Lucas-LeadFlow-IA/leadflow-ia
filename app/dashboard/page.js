        ...
        >
          {[
            ...
            <motion.div
              ...
              className="p-6 rounded-2xl bg-gray-900/50 border border-gray-800 hover:border-gray-700 transition-all cursor-pointer"
            >
            ...
            {modules.map((module, index) => {
              ...
              return (
                <motion.div
                  ...
                  className={`group relative p-6 rounded-2xl bg-gray-900/50 border transition-all cursor-pointer ${
                    isLocked 
                ...
                >
                  ...
                  <div className={`absolute inset-0 rounded-2xl bg-gradient-to-br ${module.color || 'from-violet-500 to-purple-500'} opacity-0 group-hover:opacity-5 transition-opacity pointer-events-none`} />
                </motion.div>
              )
            })}
          </div>
